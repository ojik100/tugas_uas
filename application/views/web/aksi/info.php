...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fa fa-book"></i> Info Alumni</h1>
 ...
 <div class="col-md-4 col-sm-12 mb-3">
     <div class="card">
         <img src="<?php echo base_url('upload/info/'.$a->gambar) ?>" class="card-img-top" alt="...">

         <div class="card-body">
             <div class="card-title"><h4><?= $a->nama_info ?></h4></div>
                   </div>

         <div class="card-footer">
             <a href="<?php echo site_url('User/detail_info/'.$a->id_info) ?>" class="card-link">Lihat</a>
         </div>
     </div>
